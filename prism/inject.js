window.PRISM = {
  colorstops : {
    "ink": {
      ...
      "ink8": "rgb(74, 77, 100)",
      "ink7": "rgb(96, 99, 118)",
      "ink6": "rgb(138, 141, 158)",
      "ink5": "rgb(198, 200, 211)",
      "ink4": "rgb(222, 223, 230)",
      "ink3": "rgb(235, 235, 239)",
      "ink2": "rgb(244, 244, 246)",
      "ink1": "rgb(255, 255, 255)"
    }
  },
...
whatcolor: function (x){
  var stops = [PRISM.colorstops.ink];
  var colors = ['Default'];
  var str = '';
...
prezep: function (e){
  ...
  document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(box);
  ...
  if ( dy > 0 ){
    ...
    document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(yline);
  }
  ...
  if ( dx > 0 ){
    ...
    document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(xline);
  ...
  if ( y1 > y1b && y2 < y2b || y1 < y1b && y2 > y2b ){
    ...
    if ( bottomy > .5 ){
      ...
      document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(y2line);
    }
  }
  ...
  if ( x1 > x1b && x2 < x2b || x1 < x1b && x2 > x2b ){
    ...
    if ( rightx > .5 ){
      ...
      document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(x2line);
    }
  }
...
zeplin: function (e){
  ...
  var actualWidth = document.body.getBoundingClientRect().width;//Math.max( document.body.scrollWidth, document.body.offsetWidth, document.documentElement.clientWidth, document.documentElement.scrollWidth, document.documentElement.offsetWidth );
  ...
  for( var i=0;i<boxshadow.length;i++){
    ...
    boxhtml += '<div>';
      boxhtml += '<div class=PRISMitem><span class=PRISMlabel>Color</span> <span class=value>' + shadowcolor + '</span></div><br>';
      boxhtml += '<div class=PRISMitem><span class=PRISMlabel>Offset-X</span> <span class=value>' + box[0] + '</span></div>';
      boxhtml += '<div class=PRISMitem><span class=PRISMlabel>Offset-Y</span> <span class=value>' + box[1] + '</span></div><br>';
      boxhtml += '<div class=PRISMitem><span class=PRISMlabel>Blur</span> <span class=value>' + box[2] + '</span></div>';
      boxhtml += '<div class=PRISMitem><span class=PRISMlabel>Spread</span> <span class=value>' + box[3] + '</span></div>';
    boxhtml += '</div>';
  }
  ...
  var psreds = document.getElementsByClassName('PRISMredlinewrap')[0];
  if ( !psreds ){
    psreds = document.createElement('div');
    psreds.className = 'PRISMredlinewrap';
    document.body.appendChild(psreds);
  }

  psreds.appendChild(superwrap);
...
cssfakie2: function (e){
    ...
    document.getElementsByClassName('PRISMredlinewrap')[0].appendChild(sheet);
 ...
 `<div class=infopanel>
  ...
  <div class=PRISMscroll>
    ...
    <div class="sub name">
      ...
      <div>
        <div class=PRISMitem><span class=PRISMlabel>Width</span> <span class=value>{width}px</span></div>
        <div class=PRISMitem><span class=PRISMlabel>Height</span> <span class=value>{height}px</span></div>
      </div>
      <div class=PRISMitem style="display:{showopacity}">
        <div class=PRISMitem><span class=PRISMlabel>Opacity</span> <span class=value>{opacity}</span></div>
      </div>
      <div class=PRISMitem><span class=PRISMlabel>Type</span>  <span class=value>{elementname}</span></div>
    </div>
    <div class="sub fillinfo" style="display:{fill};">
      ...
      <!--<div class=PRISMitem><span class=PRISMlabel>Swatch</span> <span class=value>{colorInfo}</span></div>-->
      <div class=PRISMitem><span class=PRISMlabel>RGB</span> <span class=value>{rgbfill}</span></div>
      <div class=PRISMitem><span class=PRISMlabel>Hex</span> <span class=value>{hexfill}</span></div>
    </div>
    <div class="sub typeinfo" style="display:{font};">
      ...
      <span class=fontpreview style="line-height:1;margin-bottom:4px;display:block;background:{fillColor};padding:4px;border-radius:2px;font-size:{font-size};color:{fontRGB};font-weight:{font-weight};vertical-align:middle;box-shadow:0 0 0 1px rgba(0,0,0,.05);min-width: 32px;text-align: center;box-sizing:border-box;">Aa</span><span class=fontvalue>
        <div class=PRISMitem><span class=PRISMlabel>Typeface</span> <span class=value>{fontFamily}</span></div>
        <div class=PRISMitem><span class=PRISMlabel>Size</span> <span class=value>{fontSize}</span></div>
        <div class=PRISMitem><span class=PRISMlabel>Weight</span> <span class=value>{fontWeight}</span></div>
        <!--<div class=PRISMitem><span class=PRISMlabel>Swatch</span> <span class=value>{fontColor}</span></div>-->
        <div class=PRISMitem><span class=PRISMlabel>RGB</span> <span class=value>{fontRGB}</span></div>
        <div class=PRISMitem><span class=PRISMlabel>Hex</span> <span class=value>{fontHex}</span></div>
        <div class=PRISMitem><span class=PRISMlabel>Line Height</span> <span class=value>{lineHeight}</span></div>
        <div class=PRISMitem><span class=PRISMlabel>OpenType</span> <span class=value>{opentype}</span></div>
				<div class=PRISMitem><span class=PRISMlabel>Font Type</span> <span class=value>{fontType}</span></div>
      </span>
    </div>
    <div class="sub borderinfo" style="display:{border};">
      ...
      <div style="vertical-align:top;">
        ...
        <div class=info>
          <div class=PRISMitem><span class=PRISMlabel>Color</span> <span class=value><span style="display:inline-block;height:16px;width:24px;background:{borderColor};border-radius:2px;"></span></span></div>
          <!--<div class=PRISMitem><span class=PRISMlabel>Swatch</span> <span class=value>{borderSwatch}</span></div>-->
          <div class=PRISMitem><span class=PRISMlabel>RGB</span> <span class=value>{borderColor}</span></div>
          <div class=PRISMitem><span class=PRISMlabel>Hex</span> <span class=value>{borderColorHex}</span></div>
          <div class=PRISMitem><span class=PRISMlabel>Style</span> <span class=value>{borderStyle}</span></div>
        </div>
      </div>
    </div>
    <div class="sub borderinfo" style="display:{borderRadius};">
      ...
      <div class=break></div>
      <div class="PRISMitem uglify">
        <span class=PRISMcolumn>
          <span class=PRISMlabel>Top Left</span> <span class=value>{borderRadiusTopLeft}</span>
        </span>
        <span class=PRISMcolumn>
          <span class=PRISMlabel>Top Right</span> <span class=value>{borderRadiusTopRight}</span>
        </span>
      </div>
      <div class="PRISMitem uglify">
        <span class=PRISMcolumn>
          <span class=PRISMlabel>Bottom Left</span> <span class=value>{borderRadiusBottomLeft}</span>
        </span>
        <span class=PRISMcolumn>
          <span class=PRISMlabel>Bottom Right</span> <span class=value>{borderRadiusBottomRight}</span>
        </span>
      </div>
    </div>
    ...
    <div class="sub paddinginfo" style="display:{padding};">
      ...
      <div>
          ...
          <div class="PRISMitem uglify">
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Top</span> <span class=value>{paddingTop}px</span>
            </span>
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Bottom</span> <span class=value>{paddingBottom}px</span>
            </span>
          </div>
          <div class="PRISMitem uglify">
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Left</span> <span class=value>{paddingLeft}px</span>
            </span>
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Right</span> <span class=value>{paddingRight}px</span>
            </span>
          </div>
      </div>
    </div>
    <div class="sub spacinginfo" style="display:{margin};">
      ...
      <div>
          ...
          <div class="PRISMitem uglify">
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Top</span> <span class=value>{marginTop}px</span>
            </span>
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Bottom</span> <span class=value>{marginBottom}px</span>
            </span>
          </div>
          <div class="PRISMitem uglify">
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Left</span> <span class=value>{marginLeft}px</span>
            </span>
            <span class=PRISMcolumn>
              <span class=PRISMlabel>Right</span> <span class=value>{marginRight}px</span>
            </span>
          </div>
      </div>
    </div>
...
`,
  ...
  setup: function (){
    ...
    link.href = ugh.extension ? ugh.extension.getURL('styles.css') : '../prism/styles.css';
    ...
    var psreds = document.createElement('div');
    psreds.className = 'PRISMredlinewrap';
    document.body.appendChild(psreds);
  ...
  eject: function() {
    ...
    var wrap = document.getElementsByClassName('PRISMredlinewrap');
    while(wrap[0]){
